                         ...
                         ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    ((ke_msg_send_handler)SVC_ke_msg_send)(add_svc_rsp);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    /* send command response message. */
    ((ke_msg_send_handler)SVC_ke_msg_send)(svc_get_perm_rsp);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    /* send command response message. */
    ((ke_msg_send_handler)SVC_ke_msg_send)(svc_set_perm_rsp);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    /* send command response message. */
    ((ke_msg_send_handler)SVC_ke_msg_send)(get_att_perm_rsp);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    /* send command response message. */
    ((ke_msg_send_handler)SVC_ke_msg_send)(set_att_perm_rsp);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    /* send command response message. */
    ((ke_msg_send_handler)SVC_ke_msg_send)(get_att_val_rsp);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    /* send command response message. */
    ((ke_msg_send_handler)SVC_ke_msg_send)(set_att_val_rsp);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    ((ke_msg_send_handler)SVC_ke_msg_send)(destroy_db_rsp);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    /* send command response message. */
    ((ke_msg_send_handler)SVC_ke_msg_send)(get_svc_list_rsp);
                                          ...
                                          ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    /* send command response message. */
    ((ke_msg_send_handler)SVC_ke_msg_send)(att_info_rsp);
...
const struct ke_state_handler task_gattm_msg_default_handler = KE_STATE_HANDLER(gattm_msg_handler_tab);
/// GATT Manager task instance.
ke_state_t gattm_state[GATTM_IDX_MAX];

/// GATTM task descriptor
const struct ke_task_desc TASK_DESC_GATTM = {NULL, &task_gattm_msg_default_handler, gattm_state, GATTM_IDX_MAX,1, ARRAY_LEN(gattm_msg_handler_tab)};
