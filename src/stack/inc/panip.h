...
// 32K rc 校准次数
#define CLK_CALIB_TIMES 			31
// 32k RC频率误差修正
#define CLK_FREQ_CORR_OFFSET			15
...
extern uint32_t t_cnt;
extern uint8_t coarse_code;
extern uint8_t fine_code;
extern uint32_t real_32K_freq;
extern uint32_t calib_32k_intval;//unit time 625us.
extern uint32_t last_calib_time;
extern uint32_t cur_calib_time;
extern bool rc_period_calib;
extern void rc_set_calib_intval(uint32_t val);
extern uint32_t rc_start_filter_code(void);
extern void rc_period_do_calib(void);
extern void rc_check_period_calib(void);
///@} ROOT
/// RWBT Environment
