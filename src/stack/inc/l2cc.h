...
#define L2CC_SIG_PDU_ALLOC(conidx, code, src_id, type) \
    ((struct type*) ((l2cc_pdu_alloc_handler)SVC_l2cc_pdu_alloc)(conidx, L2C_CID_LE_SIGNALING, code, src_id, 0))
...
#define L2CC_SMP_PDU_ALLOC(conidx, code, src_id, type) \
    ((struct type*) ((l2cc_pdu_alloc_handler)SVC_l2cc_pdu_alloc)(conidx, L2C_CID_SECURITY, code, src_id, 0))
...
#define L2CC_ATT_PDU_ALLOC(conidx, code, src_id, type)\
    ((struct type*) ((l2cc_pdu_alloc_handler)SVC_l2cc_pdu_alloc)(conidx, L2C_CID_ATTRIBUTE, code, src_id, 0))
...
#define L2CC_ATT_PDU_ALLOC_DYN(conidx, code, src_id, type, length)\
    ((struct type*) ((l2cc_pdu_alloc_handler)SVC_l2cc_pdu_alloc)(conidx, L2C_CID_ATTRIBUTE, code, src_id, length))
