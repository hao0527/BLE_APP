...
#ifndef PANBLE_HL_CONFIG_H_
#define PANBLE_HL_CONFIG_H_
...
#ifndef   BLE_LECB
#if (BLE_CENTRAL || BLE_PERIPHERAL)
#define BLE_LECB                   	0		// 1 ,DYC disabled
#else
#define BLE_LECB                    0
#endif // (BLE_CENTRAL || defined(CFG_ATTC))
#endif // BLE_ATTC
...
/// Size of the heap
    ...
    /// some heap must be reserved for attribute database
        ...
        #define BLEHL_HEAP_DB_SIZE                 (1024)  //(3072), DYC disabled
    #else
...
#define BLE_HOST_TASK_SIZE    5
#define BLE_PRF_TASK_SIZE    6
