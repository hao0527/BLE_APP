 ...
 *
 * @retval PAN_SUCCESS The packet is reserved successfully, and pp_packet points to
 * a valid packet pointer instance.
 * @retval PAN_ERROR_NO_MEM The packet buffer does not have enough available memory.
 * @retval PAN_ERROR_INVALID_LENGTH The length of the packet requested cannot be 0 or greater
 ...
 *
 * @retval PAN_SUCCESS A committed packet was found and popped successfully.
 * pp_packet points to a valid packet pointer instance.
 * @retval PAN_ERROR_NOT_FOUND The packet buffer has no packets in @ref
