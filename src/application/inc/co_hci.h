...
#include "panip_config.h"   // IP configuration
...
enum hci_opcode
{
	...
	HCI_EXTENSION_RESET_OPCODE                  = 0xFC70,
    HCI_EXTENSION_SET_TX_POWER_OPCODE           = 0xFC71,
    HCI_EXTENSION_SET_TX_DATA_OPCODE            = 0xFC72,
    HCI_EXTENSION_TX_TEST_OPCODE                = 0xFC73,
    HCI_EXTENSION_RX_TEST_OPCODE                = 0xFC74,
    HCI_EXTENSION_TEST_END_OPCODE               = 0xFC75,
    
    HCI_EXTENSION_SET_TX_COUNT_OPCODE           = 0xFC76,   
    HCI_EXTENSION_SET_TX_PDU_OPCODE             = 0xFC77,
 	HCI_EXTENSION_SET_RX_MODE_OPCODE            = 0xFC78,
};
