...
#define KE_MSG_ALLOC(id, dest, src, param_str) \
    (struct param_str*) ((ke_msg_alloc_handler)SVC_ke_msg_alloc)(id, dest, src, sizeof(struct param_str))
 ...
 ****************************************************************************************
 */
#define KE_MSG_FREE(param_ptr) ((ke_msg_free_handler)SVC_ke_msg_free)(ke_param2msg((param_ptr)))
 ...
 ****************************************************************************************
 */
#define KE_MSG_ALLOC_DYN(id, dest, src, param_str,length)  (struct param_str*)((ke_msg_alloc_handler)SVC_ke_msg_alloc)(id, dest, src, \
