...
struct co_buf_tx_node *ble_util_buf_bufptr_2_txnode(uint32_t  buf_ptr);
void ble_util_buf_acl_tx_free(uint16_t buf_ptr);


uint32_t ble_util_rx_hdl_2_buf_bufptr(uint8_t rx_hdl);
void ble_util_buf_rx_free(uint16_t buf_ptr);
