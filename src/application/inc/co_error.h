...
#define CO_ERROR_UNACCEPTABLE_CONN_PARAM           0x3B
...
#define CO_ERROR_TYPE0_SUBMAP_NOT_DEFINED          0x41
#define CO_ERROR_UNKNOWN_ADVERTISING_ID           0x42
#define CO_ERROR_LIMIT_REACHED          		0x43
#define CO_ERROR_OPERATION_CANCELED_BY_HOST     0x44
