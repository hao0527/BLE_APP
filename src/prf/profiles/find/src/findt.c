...
proj_findme_server_printf("findme_server_init, app_task:%d,prf_task:%d\n",app_task,findt_env->prf_env.prf_task);
...
{
	proj_findme_server_printf("findme_server_create\n");
...
{
	proj_findme_server_printf("findme_server_cleanup\n");
