 ...
 * $Revision: 2$
 * $Date: 16/02/25 10:23 $
 * @brief    PN102 series WWDT driver header file
 *
 * @note
...
/** @addtogroup PN102_WWDT_Driver WWDT Driver
  @{
*/

/** @addtogroup PN102_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group PN102_WWDT_EXPORTED_CONSTANTS */


/** @addtogroup PN102_WWDT_EXPORTED_FUNCTIONS WWDT Exported Functions
  @{
*/
...
/*@}*/ /* end of group PN102_WWDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group PN102_WWDT_Driver */
