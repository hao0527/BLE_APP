 ...
 * $Revision: 2 $
 * $Date: 16/02/24 15:51 $
 * @brief    PN102 series TIMER driver header file
 *
 * @note
...
/** @addtogroup PN102_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup PN102_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
#define TIMER_CAPTURE_BOTH_EDGE                 (2UL << TIMER_EXTCTL_CAPEDGE_Pos)  /*!< Both edge trigger timer capture */
...
#define	TIMER_CAPTURE_SOURCE_32K_OUTPUT		(1UL << TIMER_CTL_CAPSRC_Pos)
#define	TIMER_CAPTURE_ACMPSSEL_0						(0UL)
#define	TIMER_CAPTURE_ACMPSSEL_1						(1UL << TIMER_EXTCTL_ACMPSSEL_Pos)

/*@}*/ /* end of group PN102_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup PN102_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
/*@}*/ /* end of group PN102_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group PN102_TIMER_Driver */
