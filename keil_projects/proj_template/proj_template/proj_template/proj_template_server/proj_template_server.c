...
const struct attm_desc proj_template_server_att_db[PROJ_TEMPLATE_IDX_NB] =
{
	...
	[PROJ_TEMPLATE_IDX_TEMPER_CHAR]       = { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_TEMPER_VAL]        = { TRX_CHAR_TEMPER_UUID, PERM(RD, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },
	...
	[PROJ_TEMPLATE_IDX_BINDING_CHAR]       = { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_BINDING_VAL]        = { TRX_CHAR_BINDING_UUID, PERM(RD, ENABLE) | PERM(WRITE_COMMAND, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },
	
	[PROJ_TEMPLATE_IDX_DISCOVER_CHAR]       = { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_DISCOVER_VAL]        = { TRX_CHAR_DISCOVER_UUID, PERM(WRITE_REQ, ENABLE), 0, PROJ_TEMPLATE_SERVER_PACKET_SIZE },
	...
	[PROJ_TEMPLATE_IDX_C2S_USER_DESC]   = { ATT_DESC_CHAR_USER_DESCRIPTION, PERM(RD, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_C2S_USER_DESC_VAL_LEN },
};
